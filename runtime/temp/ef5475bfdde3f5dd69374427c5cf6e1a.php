<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"C:\wwwroot\119.29.24.237\public/../application/index\view\order\confirm.html";i:1506567154;s:74:"C:\wwwroot\119.29.24.237\public/../application/index\view\public\head.html";i:1505615883;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <script>
        ...
        $(".o2o_pay").click(function(){
            ...
            url = "<?php echo url('order/index',['id'=>$deal['id']]); ?>"+"&deal_count="+count+"&deal_price="+price;
            self.location = url;
        });
    </script>
</body>
