<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"C:\wwwroot\119.29.24.237\o2o\public/../application/index\view\lists\index.html";i:1505615882;s:78:"C:\wwwroot\119.29.24.237\o2o\public/../application/index\view\public\head.html";i:1505615883;s:77:"C:\wwwroot\119.29.24.237\o2o\public/../application/index\view\public\nav.html";i:1505615883;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="page-body">
                ...
                <div class="w-sort-bar">
                    <div class="bar-area" style="position: relative; left: 0px; margin-left: 0px; margin-right: 0px; margin-top: 0px; top: 0px;">
                        <span class="sort-area">
                            <a href="<?php echo url('lists/index',['id'=>$id]); ?>" class="sort-default <?php if($orderflag == ''): ?> sort-default-active<?php endif; ?>">默认</a>
                ...
                <?php if(is_array($deals) || $deals instanceof \think\Collection || $deals instanceof \think\Paginator): $i = 0; $__LIST__ = $deals;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <li class="j-card">
                        ...
                        <div class="contentbox">
                            ...
                            <div class="footer">
                                 <span class="sold"><?php echo $vo['buy_count']; ?></span>
        ...
        <div class="content-wrap"><?php echo paginate($deals); ?></div>
    </div>
