<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"C:\wwwroot\119.29.24.237\public/../application/index\view\detail\index.html";i:1505615881;s:74:"C:\wwwroot\119.29.24.237\public/../application/index\view\public\head.html";i:1505615883;s:73:"C:\wwwroot\119.29.24.237\public/../application/index\view\public\nav.html";i:1505615883;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                            ...
                            <a class="link jingxuan-box" alt="更多精选品牌特惠">
                                <div class="box">
                                    ...
                                    <div class="jx-update" id="j-jxUpdateTime">
                                        <span>距离开始时间还有</span>
                                        <span class="jx-timerbox"><?php echo $timedate; ?></span>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="buy-panel-wrap">
                            <div class="buy-panel">
                                ...
                                <div class="item-buy-area">
                                    ...
                                    <?php if($flag == 1): ?>
 <a  class="btn-buy btn-buy-qrnew j-btn-buy btn-hit" style="background-color: #C0C0C0;border-bottom:#C0C0C0;">立即抢购</a>
                                    <?php else: ?>    
            ...
            <div class="iim-wrapper">
                ...
                <ul class="j-info-all">
                    <li class="tab">
                                                ...
                                                <div class="w-branch-list">
                                                    ...
                                                    <?php if(is_array($locations) || $locations instanceof \think\Collection || $locations instanceof \think\Paginator): $i = 0; $__LIST__ = $locations;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>   
                                                        <li class="branch branch-open">
                                                            <a target="_blank" class="branch-name"><?php echo $vo['name']; ?>(<?php echo $key+1; ?>店)</a>
                        ...
                        <div class="ifram"><?php echo $deal->description; ?><br/>本单详情（此处高度随着填充的内容自动变化）</div>
                    </li>
                    <li class="tab"><div class="ifram">消费提示（此处高度随着填充的内容自动变化）</div></li>
                    <li class="tab"><div class="ifram"><?php echo $bis->description; ?><br/>商家介绍（此处高度随着填充的内容自动变化）</div></li>
                </ul>
            </div>
        </div>
    </div>
