<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"C:\wwwroot\119.29.24.237\o2o\public/../application/index\view\index\index.html";i:1505615881;s:78:"C:\wwwroot\119.29.24.237\o2o\public/../application/index\view\public\head.html";i:1505615883;s:77:"C:\wwwroot\119.29.24.237\o2o\public/../application/index\view\public\nav.html";i:1505615883;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <?php endif; ?><div class="nav-bar-header">
        <div class="nav-inner">
            <ul class="nav-list">
                <li class="nav-item">
    ...
    <div class="container">
        <div class="top-container">
            <div class="mid-area">
                <div class="slide-holder" id="slide-holder">
                    ...
                    <ul class="slideshow">
                    <?php if(is_array($bigImages) || $bigImages instanceof \think\Collection || $bigImages instanceof \think\Paginator): $i = 0; $__LIST__ = $bigImages;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>    
        ...
        <div class="right-sidebar">
            <div class="right-ad">
                <ul class="slidepic">
                <?php if(is_array($smallImages) || $smallImages instanceof \think\Collection || $smallImages instanceof \think\Paginator): $i = 0; $__LIST__ = $smallImages;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>    
                ...
                <div class="floor-content-start">
                    ...
                    <div class="floor-content">
                        <div class="floor-header">
                            ...
                            <?php if(is_array($foodCates) || $foodCates instanceof \think\Collection || $foodCates instanceof \think\Paginator): $i = 0; $__LIST__ = $foodCates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        ...
                        <?php if($dealFoods): if(is_array($dealFoods) || $dealFoods instanceof \think\Collection || $dealFoods instanceof \think\Paginator): $i = 0; $__LIST__ = $dealFoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <li class="j-card">
                                <a>
                                    <div class="imgbox">
